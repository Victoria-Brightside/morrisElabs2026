...
// --- Componente FINAL con ICONOS para renderizar bloques de código ---
const CodeBlock = ({ node, children, ...props }: any) => {
  // 1. Cambiamos el estado para manejar si fue copiado o no
  ...
  const handleCopy = () => {
    if (codeText) {
      navigator.clipboard.writeText(codeText)
        .then(() => {
          // 2. Actualizamos el estado a 'copiado'
          setIsCopied(true);
          // Y lo revertimos después de 2 segundos
  ...
  return (
    <div className="code-block-wrapper">
      ...
      >
        {/* 3. Mostramos un icono u otro dependiendo del estado */}
        {isCopied ? (
          // Icono de Check (confirmación)
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
        ) : (
          // Icono de Copiar (por defecto)
